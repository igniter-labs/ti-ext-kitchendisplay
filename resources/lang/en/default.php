...
return [
    ...
    'help_locations' => 'Leave empty to select all locations',
    'help_order_status' => 'Leave empty to select all order statuses',
    'help_order_types' => 'Leave empty to select all order types',
    'help_menu_categories' => 'Leave empty to select all menu categories',
